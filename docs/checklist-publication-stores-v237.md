# Checklist publication Play Store / App Store V237
...
- [ ] Version visible : V237.
- [ ] Cache Cloudflare purgé après l'envoi du ZIP V237.
...
- [ ] Captures Android sur la version V237.
- [ ] Captures iPhone sur la version V237.
...
- [ ] Déclarations de collecte de données alignées avec la politique V237.
...
- [ ] Fonction Supabase `voice-transcribe` V237 déployée avec le secret `OPENAI_API_KEY`.
