# Checklist publication Play Store / App Store V239
...
- [ ] Version visible : V239.
- [ ] Cache Cloudflare purgé après l'envoi du ZIP V239.
...
- [ ] Captures Android sur la version V239.
- [ ] Captures iPhone sur la version V239.
...
- [ ] Déclarations de collecte de données alignées avec la politique V239.
...
- [ ] Fonction Supabase `voice-transcribe` V239 déployée avec le secret `OPENAI_API_KEY`.
