# Checklist publication Play Store / App Store V241
...
- [ ] Version visible : V241.
- [ ] Cache Cloudflare purgé après l'envoi du ZIP V241.
...
- [ ] Captures Android sur la version V241.
- [ ] Captures iPhone sur la version V241.
...
- [ ] Déclarations de collecte de données alignées avec la politique V241.
...
- [ ] Fonction Supabase `voice-transcribe` V241 déployée avec le secret `OPENAI_API_KEY`.
