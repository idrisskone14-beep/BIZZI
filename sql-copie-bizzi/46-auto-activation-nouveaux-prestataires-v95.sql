-- Bizzi V95 - Auto-activation du mois gratuit pour les nouveaux prestataires
-- A executer une seule fois dans Supabase SQL Editor.
--
-- Nouvelle regle metier :
-- - un nouveau prestataire qui s'inscrit depuis l'application est automatiquement
--   visible pendant 30 jours ;
-- - l'admin garde la validation des forfaits payants, des renouvellements et
--   des controles de qualite.
...
select
  'public_activate_provider_trial installee' as verification,
  routine_schema,
  routine_name
from information_schema.routines
where routine_schema = 'public'
  and routine_name = 'public_activate_provider_trial';
