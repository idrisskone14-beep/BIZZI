-- Bizzi - Offres emploi payantes Supabase V67
-- Objectif :
-- - rendre le paiement obligatoire avant validation admin d'une offre emploi
-- - publier uniquement les offres payees et validees
-- - rester compatible si le fichier V66 n'a pas encore ete execute.
--
