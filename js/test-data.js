(function () {
  ...
  function provider(service, index) {
    ...
    return {
      ...
      description: `Profil de démonstration Bizzi pour tester le métier ${service.name}. Ne pas contacter comme prestataire réel.`,
      status: "approved",
      visibility: "active",
      verificationStatus: "verified",
      verifiedAt: new Date().toISOString(),
      verificationNote: "Profil de test Bizzi.",
  ...
  function food(index, specialty, area) {
    return {
      ...
      city: "Abidjan",
      area,
      address: `${area}, zone de test Bizzi`,
      averageBudget: `${3000 + index * 1000} FCFA`,
      openingHours: "Test : 08:00–22:00",
      deliveryAvailable: true,
      description: "Restaurant fictif réservé aux essais fonctionnels Bizzi.",
      rating: 4.5 + index / 10,
      status: "published",
      verificationStatus: "verified",
  ...
  function event(index, category, title, area) {
    return {
      ...
      organizerName: "Équipe test Bizzi",
      ...
      description: "Événement fictif réservé aux essais fonctionnels Bizzi.",
      amount: 0,
  ...
  function fallyTestEvent(previous = {}) {
    ...
    return {
      ...
      ticketUrl: "",
      description: "Concert fictif réservé au test du parcours Premium et du boost Bizzi. Ne constitue pas une annonce officielle.",
  ...
  function joseyFeaturedEvent(previous = {}) {
    ...
    return {
      ...
      amount: 3000000,
      currency: "FCFA",
      paymentMethod: "Mise en avant Bizzi",
