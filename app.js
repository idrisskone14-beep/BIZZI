...
function assistantServiceHints() {
  return {
    ...
    "Transport de colis international": ["colis", "paquet", "bagage", "europe", "france", "paris", "international", "etranger", "agence de transport", "fret", "cargo", "envoyer", "expedier", "livraison europe", "moins cher", "diaspora"],
    "Agence événementielle / organisateur événements": ["evenementiel", "evenement", "organisateur evenement", "organisatrice evenement", "organisation evenement", "agence evenementielle", "planificateur evenement", "wedding planner"],
