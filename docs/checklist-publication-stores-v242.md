# Checklist publication Play Store / App Store V242
...
- [ ] Version visible : V242.
- [ ] Cache Cloudflare purgé après l'envoi du ZIP V242.
...
- [ ] Captures Android sur la version V242.
- [ ] Captures iPhone sur la version V242.
...
- [ ] Déclarations de collecte de données alignées avec la politique V242.
...
- [ ] Fonction Supabase `voice-transcribe` V242 déployée avec le secret `OPENAI_API_KEY`.
