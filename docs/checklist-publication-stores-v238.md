# Checklist publication Play Store / App Store V238
...
- [ ] Version visible : V238.
- [ ] Cache Cloudflare purgé après l'envoi du ZIP V238.
...
- [ ] Captures Android sur la version V238.
- [ ] Captures iPhone sur la version V238.
...
- [ ] Déclarations de collecte de données alignées avec la politique V238.
...
- [ ] Fonction Supabase `voice-transcribe` V238 déployée avec le secret `OPENAI_API_KEY`.
