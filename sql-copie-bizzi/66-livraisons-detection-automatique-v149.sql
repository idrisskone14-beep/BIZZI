-- Bizzi V149 - Detection automatique des heures de pointe livraison
-- A executer dans Supabase SQL Editor apres le deploiement V149.
-- Le client ne choisit plus heure normale / pointe / nuit : Bizzi calcule selon scheduled_at.
...
create index if not exists idx_delivery_requests_scheduled_at
on public.delivery_requests(scheduled_at);
...
select
  'Bizzi V149 detection automatique livraison installee' as message,
