-- Bizzi V187 - Correctif ordre colonnes public_provider_directory
-- A executer si Supabase affiche :
-- "cannot change name of view column requested_service_name to boost_ends_at"
...
select
  'Correctif V187 ordre vue applique' as message,
