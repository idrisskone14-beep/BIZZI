-- Bizzi V147 - Paiements livraison et commission 15%
-- A executer dans Supabase SQL Editor apres les scripts livraisons precedents.
...
select
  'Bizzi V147 livraisons paiement commission installe' as message,
